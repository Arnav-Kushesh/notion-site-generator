# Notion Site Generator — Use Cases

Notion Site Generator is a powerful, open-source static website generator that uses **Notion as a headless CMS**. Below are the key use cases it enables.
...
- **No revenue sharing**: Unlike Medium or Substack, Notion Site Generator doesn't take a cut
...
Notion Site Generator's `html_section` and `iframe_section` give you the flexibility to embed anything:
...
Notion Site Generator generates fully static HTML pages optimized for search engines:
